...
const renderSubRowMasterSubKegiatan = ({ row }) => <SubRowMasterSubKegiatan row={row} />;

const SubRowMasterSubKegiatan = ({ row }) => {
...
SubRowMasterSubKegiatan.propTypes = {
  row: PropTypes.any
};

export default renderSubRowMasterSubKegiatan;
