...
import renderSubRowMasterSubKegiatan from './SubRowMasterSubKegiatan';
import Chip from 'components/ui-component/extended/Chip';
import FormSubKegiatan from 'components/form/Kemiskinan/FormSubKegiatan';

const TabMasterSubKegiatan = ({ setValue, setParams }) => {
    ...
    <>
      ...
      <SubCard content={false}>
        <AppTable
          ...
          renderSubComponent={renderSubRowMasterSubKegiatan}
        />
      </SubCard>
    </>
  );
